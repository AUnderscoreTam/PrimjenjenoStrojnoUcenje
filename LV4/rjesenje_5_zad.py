...
# pogreška se smanjuje pa pocne rast
# ovdije je i 6ti zadatak riješen
...
dummies = pd.get_dummies(df, columns=['transmission'], drop_first=True)
X = pd.concat([X, dummies], axis=1)

X = X.drop(columns=['name', 'owner', 'fuel', 'seller_type'])
...
ax.set(xlabel='Predikcija', ylabel='Stvarna vrijednost',
